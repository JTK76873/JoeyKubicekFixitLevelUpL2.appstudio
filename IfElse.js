...
if (userArray[1] == "NE" && userArray[2] < 32){
...
else if  (userArray[1] == "NE" && userArray[2] > 32 && userArray[2] < 50 ){
...
if  (userArray[1] == "FL" && userArray[2] > 32 && userArray[2] < 50 ){
...
else if  (userArray[1] == "FL" && userArray[2] > 50 && userArray[2] < 70 ){
